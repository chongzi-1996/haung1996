...
<%		request.setCharacterEncoding("utf-8");
		String info=request.getParameter("kind");
	 ...
	 <%@ include file = "nav.jsp" %>
	    ...
	    <div class="col-md-offset-1">
	    		...
	    		String sql="select * from goods where Gkind like '%"+info+"%' or Gkind='"+info+"'";
	    		System.out.println(sql);
				ResultSet result= db.doQuery(sql);
		 %>
	  		<h3 class="page-header"><%=info %>商品</h3>
	  		<div class="row" >
	  		<%
			  while(result.next()){
			  %>
		  		<div class="thumbnail col-md-3" id="onegood">
		  			...
		  			<div class="caption">
		  				...
		  				<div class="pull-right">
			  				...
			  				<a href=""><button class="btn btn-info">购物车</button></a>
			  			</div>
		  			</div>
		  		</div>
		<%
